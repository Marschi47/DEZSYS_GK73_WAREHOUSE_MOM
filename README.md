...
## 1. Aufgabenstellung
Ziel der Übung war die Implementierung einer Kommunikationsplattform für ein verteiltes Warenlager-System. Dabei senden verschiedene Lagerstandorte (Producer) ihre Bestandsdaten asynchron an eine Zentrale (Consumer). Als Middleware wurde **Apache Kafka** verwendet. Die Zentrale aggregiert die Daten und stellt sie über eine REST-Schnittstelle bereit.
...
## 3. Beantwortung der Fragestellungen

### 3.1 Eigenschaften von Message Oriented Middleware (MOM)
...
### 3.2 Transiente und synchrone Kommunikation
...
### 3.3 Funktionsweise einer JMS Queue (Point-to-Point)
...
### 3.4 JMS Overview - Wichtigste Klassen
...
### 3.5 Funktionsweise eines JMS Topic (Publish-Subscribe)
...
### 3.6 Lose gekoppeltes verteiltes System
